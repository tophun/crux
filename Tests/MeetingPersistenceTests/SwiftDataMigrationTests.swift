...
struct SwiftDataMigrationTests {
    ...
    func migratesLegacyStore() throws {
        ...
        let legacyMeetingID = try #require(UUID(uuidString: meetingID))
        let loadedMeeting = try repository.meeting(id: legacyMeetingID)
    ...
    private func createLegacyDatabase(at url: URL) throws {
        ...
        INSERT INTO audioTrack VALUES (
            '\(trackID)', '\(meetingID)', 'mixed', '/tmp/meeting.m4a', 60.0, 16000.0, 1, 1234,
            '2023-11-14 22:13:20.000'
        );
        INSERT INTO transcriptSegment VALUES (
            '\(segmentID)', '\(meetingID)', 0, 0.0, 8.0, NULL, '배포 일정을 확정합니다.', 0.95, 'mixed', 'keep', NULL
        );
        INSERT INTO meetingNote VALUES (
            '\(meetingID)', '회의록', '배포 일정 확정', '2023-11-14 23:13:20.000', '{}', NULL
        );
        INSERT INTO decision VALUES (
            '\(decisionID)', '\(meetingID)', 0, '수요일 배포', 'decided', '[]', 0.9, 1
        );
        INSERT INTO actionItem VALUES (
            '\(actionID)', '\(meetingID)', 0, '체크리스트 공유', '홍길동', NULL, NULL, 'confirmed', '[]', 0.8, 0
        );
        ...
        INSERT INTO processingJob VALUES (
            '\(jobID)', '\(meetingID)', 'transcribe', 'succeeded', 1,
            '2023-11-14 22:13:20.000', '2023-11-14 23:13:20.000', NULL, NULL
        );
        INSERT INTO calendarEvent VALUES (
            'event-1', '마이그레이션 일정', '2023-11-14 22:13:20.000', '2023-11-14 23:13:20.000', 0,
            'confirmed', '[]', NULL, NULL, NULL, '업무', '2023-11-14 23:13:20.000'
        );
        INSERT INTO notifiedEvent VALUES ('event-1', '2023-11-14 21:13:20.000');
        INSERT INTO publishRecord VALUES (
            '\(publishID)', '\(meetingID)', NULL, 'jira', '10001', 'PROJ-1',
            'https://jira.example/PROJ-1', '2023-11-15 00:13:20.000'
        );
        """
